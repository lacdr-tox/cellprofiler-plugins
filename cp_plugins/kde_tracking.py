'''<b>kde_tracking</b> - an example image processing module
'''
...
class kde_tracking(cpm.CPModule):
   
    module_name = "kde_tracking"
    category = "DImage"
    ...
    def run(self, workspace):
        ...
        Packages.ij.IJ.run(img, "Watershed", "");
    ...
    def display(self, workspace):
        ...
        figure.subplot_imshow_grayscale(
            0, 0,
            workspace.input_pixels,
            title = self.input_image_name.value)
        
        #display binary mask
        figure.subplot_imshow_grayscale(
            1, 0,
            workspace.output_pixels,
