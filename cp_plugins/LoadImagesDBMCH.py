'''LoadImagesDBMCH.py - a plugin that loads some files
...
allprojects=["Project_1","Project_1","Project_1","Project_1","Project_1","Project_1","Project_1","Project_1","Project_1","Project_1","Project_1","Project_1"];

dbprojectlist=["project1","project2"]
dbexplist=["exp1","exp2"]
dbplatelist=["dum1","dum2"]
class LoadImagesDBMCH(cpm.CPModule):
    variable_revision_number=1
    module_name = "LoadImagesDBMCH"
    category = "ImageDB"
    ...
    def create_settings(self):
        ...
        self.add_button = cps.DoSomething("Add another set", "Add", self.add_pathname)
    ...
    def add_pathname(self, can_remove=True):
        ...
        group.append("path", cps.DirectoryPath("cache location"))
    ...
    def settings(self):
        result=[self.pathname_count, self.config_usr, self.config_pwd]
        ...
        result+=[group.path for group in self.pathnames]
    ...
    def prepare_run(self, workspace):
        ...
        for ii, curpath in enumerate(allpaths):#for each image
            ...
            for i, group in enumerate(self.pathnames):#for each channel
                ...
                pathname = group.path.get_absolute_path()
                ...
                measurements.add_measurement(cpmeas.IMAGE, pathname_feature, pathname, image_set_number = image_number)
